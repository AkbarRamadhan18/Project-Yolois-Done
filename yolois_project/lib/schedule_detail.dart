...
class _CourseInfoState extends State<CourseInfo> {
  ...
  Future<void> fetchData() async {
    final response = await http.post(
      Uri.parse('http://yo.yolois.my.id/schedule_detail.php'),
      body: jsonEncode(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10),
                          _buildInputField('Matkul', data['matkul'] ?? ''),
                          SizedBox(height: 10),
                          _buildInputField('Jumlah Orang Masuk',
                              data['jumlah_orang_masuk'] ?? ''),
                          SizedBox(height: 10),
                          _buildInputField('Jumlah Orang Keluar',
                              data['jumlah_orang_keluar'] ?? ''),
                          SizedBox(height: 20),
                          SizedBox(
